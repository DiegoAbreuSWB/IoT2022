...
model = keras.Sequential([
    ...
    keras.layers.Dense(6, activation='softmax') #mudei para 6

])
model.compile("adam", "sparse_categorical_crossentropy", metrics=["accuracy"])

data = pd.read_csv (r'C:\Users\diego\PycharmProjects\MNIST-Federated\03_Non IID Demo\bases\7.heim_multiclass.csv')#binario
